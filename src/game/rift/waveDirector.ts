...
export const RIFT_DURATION_MS    = 128_000   // longest zone end_run; HUD timer max
...
const ZONE_TIMELINES: Record<string, TimelineEvent[]> = {
  candy_cavern_rift: [
    ...
    ev(18_000,   'upgrade_choice'),
    ev(38_000,   'upgrade_choice'),
    ev(58_000,   'upgrade_choice'),
    ev(60_000,   'wave_spawn',   { wave: 6, count: 28, pattern: 'burst_sides' }),
    ev(60_000,   'wave_spawn',   { wave: 7, count: 34, pattern: 'scatter' }),
    ev(62_000,   'boss_warning', { bossId: 'boss_mushroom_matriarch' }),
    ev(65_000,   'mid_boss',     { bossId: 'boss_mushroom_matriarch' }),
    ev(83_000,   'upgrade_choice'),
    ev(88_000,   'boss_warning', { bossId: 'boss_king_slime_pop' }),
    ev(91_000,   'final_boss',   { bossId: 'boss_king_slime_pop' }),
    ev(106_000,  'end_run'),
  ],
  goblin_glitter_mines: [
    ...
    ev(20_000,   'upgrade_choice'),
    ev(42_000,   'upgrade_choice'),
    ev(62_000,   'upgrade_choice'),
    ev(64_000,   'wave_spawn',   { wave: 6, count: 30, pattern: 'burst_sides' }),
    ev(64_000,   'wave_spawn',   { wave: 7, count: 36, pattern: 'scatter' }),
    ev(66_000,   'boss_warning', { bossId: 'boss_goblin_minecart_ace' }),
    ev(69_000,   'mid_boss',     { bossId: 'boss_goblin_minecart_ace' }),
    ev(88_000,   'upgrade_choice'),
    ev(93_000,   'boss_warning', { bossId: 'boss_tax_collector_mimic' }),
    ev(96_000,   'final_boss',   { bossId: 'boss_tax_collector_mimic' }),
    ev(112_000,  'end_run'),
  ],
  void_arcade: [
    ...
    ev(22_000,   'upgrade_choice'),
    ev(46_000,   'upgrade_choice'),
    ev(66_000,   'upgrade_choice'),
    ev(68_000,   'wave_spawn',   { wave: 6, count: 30, pattern: 'burst_sides' }),
    ev(68_000,   'wave_spawn',   { wave: 7, count: 36, pattern: 'scatter' }),
    ev(70_000,   'boss_warning', { bossId: 'boss_pumpkin_gearlord' }),
    ev(73_000,   'mid_boss',     { bossId: 'boss_pumpkin_gearlord' }),
    ev(93_000,   'upgrade_choice'),
    ev(98_000,   'boss_warning', { bossId: 'boss_void_arcade_dragon' }),
    ev(101_000,  'final_boss',   { bossId: 'boss_void_arcade_dragon' }),
    ev(117_000,  'end_run'),
  ],
  moon_vault: [
    ...
    ev(24_000,   'upgrade_choice'),
    ev(50_000,   'upgrade_choice'),
    ev(70_000,   'upgrade_choice'),
    ev(72_000,   'wave_spawn',   { wave: 6, count: 32, pattern: 'burst_sides' }),
    ev(72_000,   'wave_spawn',   { wave: 7, count: 38, pattern: 'scatter' }),
    ev(74_000,   'boss_warning', { bossId: 'boss_neon_bone_hydra' }),
    ev(77_000,   'mid_boss',     { bossId: 'boss_neon_bone_hydra' }),
    ev(98_000,   'upgrade_choice'),
    ev(103_000,  'boss_warning', { bossId: 'boss_moon_vault' }),
    ev(106_000,  'final_boss',   { bossId: 'boss_moon_vault' }),
    ev(122_000,  'end_run'),
  ],
  starforge_nursery: [
    ...
    ev(26_000,   'upgrade_choice'),
    ev(54_000,   'upgrade_choice'),
    ev(74_000,   'upgrade_choice'),
    ev(76_000,   'wave_spawn',   { wave: 6, count: 34, pattern: 'burst_sides' }),
    ev(76_000,   'wave_spawn',   { wave: 7, count: 40, pattern: 'scatter' }),
    ev(78_000,   'boss_warning', { bossId: 'boss_moon_vault' }),
    ev(81_000,   'mid_boss',     { bossId: 'boss_moon_vault' }),
    ev(104_000,  'upgrade_choice'),
    ev(109_000,  'boss_warning', { bossId: 'boss_star_eater_cherub' }),
    ev(112_000,  'final_boss',   { bossId: 'boss_star_eater_cherub' }),
    ev(128_000,  'end_run'),
  ],
}
