...
const ZONE_TIMELINES: Record<string, TimelineEvent[]> = {
  candy_cavern_rift: [
    ...
    ev(102_000,  'wave_spawn',    { wave: 6, count: 28, pattern: 'burst_sides' }),
    ev(102_000,  'wave_spawn',    { wave: 7, count: 34, pattern: 'scatter' }),
  ...
  goblin_glitter_mines: [
    ...
    ev(114_000,  'wave_spawn',    { wave: 6, count: 30, pattern: 'burst_sides' }),
    ev(114_000,  'wave_spawn',    { wave: 7, count: 36, pattern: 'scatter' }),
  ...
  void_arcade: [
    ...
    ev(116_000,  'wave_spawn',    { wave: 6, count: 30, pattern: 'burst_sides' }),
    ev(116_000,  'wave_spawn',    { wave: 7, count: 36, pattern: 'scatter' }),
  ...
  moon_vault: [
    ...
    ev(118_000,  'wave_spawn',    { wave: 6, count: 32, pattern: 'burst_sides' }),
    ev(118_000,  'wave_spawn',    { wave: 7, count: 38, pattern: 'scatter' }),
